...
<div className="share items-start flex flex-col">
  ...
  <button className="btn1">
    ...
    <span className="tooltiptext1">
      ...
      <div className="username">@_aryannn.07_</div>
    </span>
  </button>
  <button className="btn2">
    ...
    <span className="tooltiptext2">
      ...
      <div className="username">@ATyagi07</div>
    </span>
  </button>
  <button className="btn3">
    ...
    <span className="tooltiptext3">
      ...
      <div className="username">@aryan3007</div>
    </span>
  </button> 
  </div>
</div>
